...
class SQLiteAdapterTestCase(unittest.TestCase):
    ...
    def test_add_player(self):
        ...
        self.assertEqual(
            players["player1"], {"shop": True, "retailer": False, "factory": False}
        )
        ...
        self.assertEqual(
            players["player2"], {"shop": False, "retailer": False, "factory": True}
        )
    ...
    def test_get_order_by_week(self):
        ...
        self.adapter.addPlayer("game1", "player2", "retailer")
        self.adapter.saveDelivery(10, 1, *identifier)
        ...
        self.assertEqual(orders[2], {"player2": {"retailer": {"delivery": 20}}})
        self.assertEqual(
            orders[3],
            {
                "player1": {"shop": {"buy": 30}},
    ...
    def test_remove_game(self):
        ...
        stat1 = self.adapter.getStat(identifier, 1)
        self.assertEqual(stat1["inventory"], 4) # Check default value
        players = self.adapter.getPlayers("game1")
